...
Web application implementing NN arbitrary style transfer model is available on the following link: https://demopyt-production.up.railway.app/style_transfer/
...
https://demopyt-production.up.railway.app/style_transfer/ 
